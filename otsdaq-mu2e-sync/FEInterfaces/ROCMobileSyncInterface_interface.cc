#include "otsdaq-mu2e-sync/FEInterfaces/ROCMobileSyncInterface_interface.h"
...
#define __MF_SUBJECT__ "FE-ROCMobileSyncInterface"
...
//=========================================================================================
ROCMobileSyncInterface::ROCMobileSyncInterface(const std::string& rocUID,
  ...
  registerFEMacroFunction(
      ...
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::Configure),
  ...
  registerFEMacroFunction("Read Histograms",
                          static_cast<FEVInterface::frontEndMacroFunction_t>(
                              &ROCMobileSyncInterface::ReadMarkerHistograms),
                          std::vector<std::string>{}, // inputs parameters
                          std::vector<std::string>{"Plotly_Plot0", "Plotly_Plot1", "Plotly_Plot2",
                                                   "histograms"}, // output parameters
                          1                                       // requiredUserPermissions
  );

  registerFEMacroFunction(
      "Reset", static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::Reset),
      std::vector<std::string>{}, // inputs parameters
      std::vector<std::string>{}, // output parameters
      1                           // requiredUserPermissions
  );
  ...
  registerFEMacroFunction(
      "Setup For Run",
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::PrepareDataRuns),
  ...
  registerFEMacroFunction(
      "Selective Reset",
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::SelectiveReset),
      std::vector<std::string>{
          "40MHz Clock Generator (Default := false)", "Forward Detector (Default := false)",
          "Command Handler (Default := false)", "Timestamp Manager (Default := false)",
          "DCS Receive FIFO (Default := false)", "ROC Monitor (Default := false)",
          "DCS Response FIFO (Default := false)", "Packet Sender (Default := false)",
          "Receive FIFO (Default := false)", "Response FIFO (Default := false)",
  ...
  registerFEMacroFunction(
      "Reset Histograms",
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::ResetHistograms),
      std::vector<std::string>{
  ...
  registerFEMacroFunction(
      "Read Rx FIFO",
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::ReadRxFIFO),
      std::vector<std::string>{},         // inputs parameters
  ...
  registerFEMacroFunction(
      "Read Tx FIFO",
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::ReadTxFIFO),
      std::vector<std::string>{},         // inputs parameters
      std::vector<std::string>{"Result"}, // output parameters
      1                                   // requiredUserPermissions
  );
  ...
  registerFEMacroFunction(
      "BERT Setup",
      static_cast<FEVInterface::frontEndMacroFunction_t>(&ROCMobileSyncInterface::BERT),
      std::vector<std::string>{"Transmit PRBS7 (Default := false)",
...
//==========================================================================================
ROCMobileSyncInterface::~ROCMobileSyncInterface(void) {
...
void ROCMobileSyncInterface::configure(void) try {
  ...
  // runSequenceOfCommands("ROCTypeLinkTable/LinkToConfigureSequence"); /*Run Configure Sequence
  // Commands*/
...
//==================================================================================================
void ROCMobileSyncInterface::Configure(__ARGS__) {
  __COUT_INFO__ << "Configure called" << __E__;
  configure();
}

//==================================================================================================
std::string ROCMobileSyncInterface::readBuffer(uint32_t loc_addr) {
  std::stringstream outss;
  for (u_int16_t i = 5; i < 20; i++) {
    outss << "0x" << std::hex << getDTC()->ReadExtROCRegister(linkID_, loc_addr, i) << __E__;
  }
  return outss.str();
}

//==================================================================================================
void ROCMobileSyncInterface::ReadTxFIFO(__ARGS__) {
  __COUT_INFO__ << "ReadTxFIFO called" << __E__;
  __SET_ARG_OUT__("Result", ROCMobileSyncInterface::readBuffer(11));
}

//==================================================================================================
void ROCMobileSyncInterface::ReadRxFIFO(__ARGS__) {
  __COUT_INFO__ << "ReadRxFIFO called" << __E__;
  __SET_ARG_OUT__("Result", ROCMobileSyncInterface::readBuffer(8));
}

//==================================================================================================
std::vector<uint16_t>
ROCMobileSyncInterface::readHistogram(std::vector<DTCLib::roc_data_t>& histAddrs, uint32_t loc_addr,
                                      std::stringstream& outss) {
  ...
  for (int i = 0; i < 5; i++) {
    ...
    outss << std::left << std::setw(12) << label << std::right << std::setw(5) << binValue << __E__;
  }
  return hist;
}

//==================================================================================================
std::array<std::string, 4> ROCMobileSyncInterface::ReadMarkerHistograms(void) {
  ...
  std::string data = "[" + StringMacros::vectorToString(histograms["loopbackFD"], ",") + "]";
  ...
  histogramFD = std::regex_replace(histogramFD, std::regex("<TITLE>"), "\"Forward Detector\"");
  ...
  histogramPS = std::regex_replace(histogramPS, std::regex("<MARKER-TYPE>"), "\"Loopback Marker\"");
  histogramPS = std::regex_replace(histogramPS, std::regex("<TITLE>"), "\"Packet Sender\"");

  data = "[" + StringMacros::vectorToString(histograms["eventTM"], ",") + "]";
  histogramTM = std::regex_replace(histogramTM, std::regex("<MARKER-DATA>"), data);
  histogramTM = std::regex_replace(histogramTM, std::regex("<MARKER-TYPE>"), "\"Event Marker\"");
  histogramTM = std::regex_replace(histogramTM, std::regex("<TITLE>"), "\"Timestamp Manager\"");

  std::array<std::string, 4> outArr = {outss.str(), histogramFD, histogramPS, histogramTM};
  return outArr;
}

//======================================================================================================
void ROCMobileSyncInterface::ReadMarkerHistograms(__ARGS__) {
  std::array<std::string, 4> result = ROCMobileSyncInterface::ReadMarkerHistograms();
...
//======================================================================================================
void ROCMobileSyncInterface::ResetHistograms(__ARGS__) {
  uint16_t resetControl = 0x0;
  bool enable = __GET_ARG_IN__("Forward Detector Loopback Markers (Default := false)", bool, false);
  resetControl = resetControl | (enable << 0);
  enable = __GET_ARG_IN__("Forward Detector Clock Markers (Default := false)", bool, false);
  resetControl = resetControl | (enable << 1);
  enable = __GET_ARG_IN__("Forward Detector Event Markers (Default := false)", bool, false);
  resetControl = resetControl | (enable << 2);
  enable = __GET_ARG_IN__("Timestamp Manager Event Markers (Default := false)", bool, false);
  resetControl = resetControl | (enable << 3);
  enable = __GET_ARG_IN__("Packet Sender Loopback Markers(Default := false)", bool, false);
...
//======================================================================================================
void ROCMobileSyncInterface::PrepareDataRuns(__ARGS__) {
...
//======================================================================================================
void ROCMobileSyncInterface::GetStatus(__ARGS__) {
  std::stringstream outss;
  ...
  outss << "Loopback Markers Received: " << getDTC()->ReadExtROCRegister(linkID_, 8, 41) << __E__;
  outss << "Loopback Markers Sent: " << getDTC()->ReadExtROCRegister(linkID_, 11, 32) << __E__;

  outss << "Last Heart Beat Received: " << getDTC()->ReadExtROCRegister(linkID_, 12, 6) << __E__;
  outss << "Last Data Request Packet: " << std::hex << getDTC()->ReadExtROCRegister(linkID_, 9, 5)
        << std::hex << getDTC()->ReadExtROCRegister(linkID_, 9, 4) << std::hex
        << getDTC()->ReadExtROCRegister(linkID_, 9, 5) << __E__;

  outss << "Number of Heart Beat Packets: " << getDTC()->ReadExtROCRegister(linkID_, 9, 22)
        << __E__;
  outss << "Number of Data Request Packets: " << getDTC()->ReadExtROCRegister(linkID_, 9, 23)
        << __E__;
  outss << "Number of DCS Packets: " << getDTC()->ReadExtROCRegister(linkID_, 9, 5) << __E__;
  ...
  outss << "===================================" << __E__;
  outss << ROCMobileSyncInterface::ReadMarkerHistograms()[0];

  __SET_ARG_OUT__("Result", "\n" + outss.str());
}

//======================================================================================================
void ROCMobileSyncInterface::BERT(__ARGS__) {
  ...
  bool fixedPatternEnabled = __GET_ARG_IN__("Fixed Pattern Enabled (Default := true)", bool, true);
