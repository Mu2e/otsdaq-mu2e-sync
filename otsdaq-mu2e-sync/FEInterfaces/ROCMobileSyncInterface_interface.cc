...
//=========================================================================================
ROCMobileSyncInterface::ROCMobileSyncInterface(
    ...
    : ROCPolarFireCoreInterface(rocUID, theXDAQContextConfigTree, theConfigurationPath)
{
	...
	registerFEMacroFunction("Configure State Machine",
	                        static_cast<FEVInterface::frontEndMacroFunction_t>(
	                            &ROCMobileSyncInterface::Configure),
	...
	registerFEMacroFunction(
	    "Setup For Run",
	    static_cast<FEVInterface::frontEndMacroFunction_t>(
	        &ROCMobileSyncInterface::PrepareDataRuns),
	...
	registerFEMacroFunction(
	    "Selective Reset",
	    static_cast<FEVInterface::frontEndMacroFunction_t>(
	        &ROCMobileSyncInterface::SelectiveReset),
	...
	registerFEMacroFunction(
	    "Reset Histograms",
	    static_cast<FEVInterface::frontEndMacroFunction_t>(
	        &ROCMobileSyncInterface::ResetHistograms),
	...
	registerFEMacroFunction("Read Rx FIFO",
	                        static_cast<FEVInterface::frontEndMacroFunction_t>(
	                            &ROCMobileSyncInterface::ReadRxFIFO),
	                        std::vector<std::string>{},          // inputs parameters
	...
	registerFEMacroFunction("Read Tx FIFO",
	                        static_cast<FEVInterface::frontEndMacroFunction_t>(
	                            &ROCMobileSyncInterface::ReadTxFIFO),
	                        std::vector<std::string>{},          // inputs parameters
	                        std::vector<std::string>{"Result"},  // output parameters
	                        1  // requiredUserPermissions
	);
...
void ROCMobileSyncInterface::configure(void)
try
{
...
//==================================================================================================
std::vector<uint16_t> ROCMobileSyncInterface::readHistogram(
